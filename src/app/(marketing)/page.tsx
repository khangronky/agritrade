        ...
        <div className="overflow-hidden border border-lime-200 bg-lime-50">
          ...
          >
            <div className="mx-auto max-w-1140px">
              <p className="text-center font-semibold text-primary text-[11px] uppercase tracking-[0.22em]">
            ...
            <div className="mt-12 border-lime-200 border-t pt-10">
              <div className="mx-auto max-w-230 px-4 sm:px-6">
                ...
                <div className="mt-8 flex justify-center">
                  <Link
                    href="/register"
                    className="inline-flex items-center rounded-full border border-lime-300 bg-lime-100 px-5 py-2.5 font-semibold text-lime-700 text-base"
                  >
