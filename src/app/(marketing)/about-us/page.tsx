        ...
        <div className="overflow-hidden border border-lime-200 bg-lime-50">
          <section className="px-4 py-6 sm:px-6 sm:py-7 lg:px-8 lg:py-9">
            <div className="grid gap-6 md:grid-cols-[1fr_1.18fr] md:items-end">
              <div>
                <p className="font-medium text-primary text-[11px] uppercase tracking-[0.24em]">
                  [About us]
                </p>
                ...
                <p className="mt-2 max-w-[220px] text-right text-muted-foreground text-[10px] leading-tight">
          ...
          <section className="border-lime-200 border-t px-4 py-7 sm:px-6 lg:px-8">
            ...
            <div className="relative mt-5 grid gap-5 md:grid-cols-[0.95fr_1.05fr]">
              <p className="max-w-[260px] text-muted-foreground text-[11px] leading-relaxed">
              ...
              <div className="mx-auto max-w-[760px] space-y-4 text-center">
                <p className="mx-auto max-w-[720px] font-semibold text-lime-950 text-base leading-snug sm:text-lg">
                ...
                <p className="font-semibold text-primary text-base leading-snug sm:text-lg">
              ...
              <p className="-z-0 absolute right-0 bottom-0 font-semibold text-lime-100 text-6xl leading-none sm:text-8xl">
                2026
              </p>
            </div>
          </section>

          <section className="border-lime-200 border-t px-4 py-7 motion-safe:animate-in motion-safe:fade-in-0 motion-safe:slide-in-from-bottom-3 motion-safe:duration-700 sm:px-6 lg:px-8">
            <p className="font-semibold text-primary text-[11px] uppercase tracking-[0.22em]">
              * Our Direction
            </p>
            ...
            <div className="mt-4 grid gap-3 md:grid-cols-3">
              {directionCards.map((card) => (
                ...
                >
                  ...
                  <p className="relative z-10 mt-3 text-muted-foreground text-[11px] leading-relaxed transition-colors duration-500 group-hover:text-primary">
                    {card.description}
                  </p>
          ...
          <section className="border-lime-200 border-t px-4 py-8 motion-safe:animate-in motion-safe:fade-in-0 motion-safe:slide-in-from-bottom-3 motion-safe:duration-700 motion-safe:delay-150 sm:px-6 lg:px-8">
            <p className="font-semibold text-primary text-[11px] uppercase tracking-[0.22em]">
              * Services
            </p>
