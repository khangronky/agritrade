...
export function AboutUsHeroSection() {
  return (
    <section className="relative border-[#d3e9b4] border-b pt-24 pb-16 sm:pt-28 sm:pb-20">
      ...
      <div className="relative mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[1.05fr_minmax(0,0.95fr)] lg:items-center lg:px-8">
        <div>
          <Badge className="border-[#c6dfa0] bg-[#f9fef0] text-[#546a39]">
            About Us
          </Badge>
          ...
          <p className="mt-6 max-w-3xl text-base text-[#546a39] leading-relaxed sm:text-lg">
          ...
          <p className="mt-4 max-w-3xl text-base text-[#546a39] leading-relaxed">
          ...
          <div className="mt-8">
            <Button
              asChild
              size="lg"
              className="border border-[#c6dfa0] bg-[#eaf7d5] font-semibold text-[#3d670d] hover:bg-[#e4f4c4]"
            >
              <Link href="/register">
                Join AgriTrade
