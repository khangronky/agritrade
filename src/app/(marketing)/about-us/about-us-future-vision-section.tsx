    ...
    <section className="pt-6 pb-16 sm:pt-8 sm:pb-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div className="rounded-3xl border border-[#cfe5ad] bg-[#f9fef0] p-6 shadow-sm sm:p-8">
            <p className="font-semibold text-[#4e820f] text-sm uppercase tracking-[0.18em]">
              Our Future Vision
            </p>
            <h2 className="mt-3 font-semibold text-3xl text-[#1f3800] leading-tight sm:text-4xl">
              Building a new generation of data-driven farmers.
            </h2>
            <p className="mt-4 text-[#546a39] leading-relaxed">
            ...
            <div className="mt-6 space-y-3">
              {futureCommitments.map((commitment) => (
                <div
                  key={commitment}
                  className="rounded-xl border border-[#cfe5ad] bg-[#f9fef0] px-4 py-3"
                >
                  <p className="text-[#365608] text-sm leading-relaxed sm:text-base">
                    {commitment}
                  </p>
                </div>
              ))}
            </div>
            <p className="mt-6 font-medium text-[#365608]">
