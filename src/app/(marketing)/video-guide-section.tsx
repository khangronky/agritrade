  ...
  return (
    <section id="video-guide" className="scroll-mt-20 py-16 sm:py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-8 rounded-3xl border border-green-200/80 bg-white/90 p-5 shadow-sm sm:p-7 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          <div className="relative aspect-video overflow-hidden rounded-2xl border border-green-200/70">
            <Image
              src="/farm.jpg"
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <CirclePlay className="size-16 text-white drop-shadow-[0_8px_16px_rgba(0,0,0,0.35)] sm:size-20" />
            </div>
          </div>
