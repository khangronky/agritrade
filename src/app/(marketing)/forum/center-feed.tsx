      ...
      <div className="rounded-2xl border border-emerald-500/20 bg-zinc-950/88 p-3 shadow-sm">
        ...
        <div className="relative mt-3">
          ...
          <Input
            ...
            className="h-10 border-border bg-muted/30 pl-9 text-sm"
          />
        </div>

        <div className="mt-3 grid grid-cols-2 divide-x divide-border rounded border border-border bg-card/60">
          <Button
            type="button"
            variant="ghost"
