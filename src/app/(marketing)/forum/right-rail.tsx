  ...
  return (
    <aside className="space-y-4">
      <section className="rounded border border-[#d3e9b4] bg-white p-3">
        ...
        <button
          type="button"
          className="mt-2 font-semibold text-[#4e820f] text-xs hover:text-[#3d670d]"
        >
          Sign in
        </button>
      </section>
          ...
          {forumOverviewItems.map((item) => (
            <li key={item.name}>
              ...
              >
                ...
                <ChevronRight className="size-4 text-[#8a9c72]" />
              </button>
            </li>
          ))}
        </ul>
      ...
      <section className="rounded border border-[#d3e9b4] bg-white p-3">
        ...
        <div className="mt-3 flex items-center justify-between">
          <button
            type="button"
            className="font-semibold text-[#4e820f] text-xs hover:text-[#3d670d]"
          >
            {forumRfq.actionLabel}
          </button>
          <ClipboardList className="size-5 text-[#6e7f5a]" />
        </div>
      </section>
    </aside>
  );
