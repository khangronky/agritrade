...
function ListingCardItem({
  ...
  return (
    <Card className="group gap-0 overflow-hidden rounded-2xl border-lime-300/80 bg-linear-to-br from-white via-white to-emerald-50/45 py-0 text-slate-900 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-lime-400 hover:shadow-md">
      <CardContent className="px-4 py-4 sm:px-5 sm:py-5">
        <div className="flex items-start justify-between gap-3">
          <div>
            <p className="font-medium text-[11px] text-lime-800 uppercase tracking-[0.16em]">
              {listing.category}
            </p>
